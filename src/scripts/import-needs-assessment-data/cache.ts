...
import { StrapiRegion, StrapiSubregion, StrapiSurvey, StrapiProduct } from "./types";
...
export async function getCachedRegions(getRegionIdsFn: typeof getRegionIds):
...
export async function getCachedSubregions(getSubregionIdsFn: typeof getSubregionIds):
...
export async function getCachedSurveys(getSurveyIdsFn: typeof getSurveyIds):
...
export async function getCachedProducts(getProductItemIdsFn: typeof getProductItemIds):
